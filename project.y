...
%token INT FLOAT CHAR BOOL VOID STRING ID READ WRITE NUM
...
%%
	...
	Function:  FUNCTION Type ID COB CCB Block 
			  |FUNCTION VOID ID COB CCB Block {printf("5");} ;
	...
	Statement: Variable_Declaration_List
			  ...
			  |READ COB ID CCB
			  |WRITE COB ID CCB
			  |ID ASSIGNMENT Arithmetic_Expression
 			  |ID ASSIGNMENT Conditional_Expression 
 			  |ID ASSIGNMENT Logical_Expression	
	...
	Arithmetic_Expression :ID Arithmetic_Operator Arithmetic_Expression 
						  |NUM 
						  |CROB Arithmetic_Expression CRCB 
						  | SOB Arithmetic_Expression SCB 
						  | COB Arithmetic_Expression CCB {printf("13 ");};

	Logical_Expression:Conditional_Expression Logical_Operator Logical_Expression 
					  |Conditional_Expression {printf("14 ");};

	Logical_Operator:AND
				    |OR {printf("14 ");};

	Conditional_Statement : IF COB Conditional_Expression CCB Block ELSE Block 
						  | IF COB Conditional_Expression CCB Block;

	Function_Call_Statement :ID COB List_Of_Identifiers CCB
							|ID ASSIGNMENT ID COB List_Of_Identifiers CCB;

	List_Of_Identifiers : NUM COMMA List_Of_Identifiers 
